...
description: "我在課程作業方面的想法、思考以及心得。所以可能寫得不盡完善，因為我的想法有時候會很跳 tone，不過我會盡量寫的通暢一些。"
...
sourceFile: "2019-08-24_-----JQuery---Bootstrap----801acadd3b61.html"
---
...
但因為 `.board` 跟 `.member__delete` 差太遠，所以就找上層元素，並嘗試印出資料。另外因為發現可以監聽子元素，所以 number__delete 就不需要分主元素或子元素了。
