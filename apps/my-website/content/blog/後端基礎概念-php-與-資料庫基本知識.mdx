...
description: "後端就是伺服器端，有個 Serve，以及 Data center 的範圍皆是。在網路上傳輸資料的時候，要發一個 request 給伺服器之後取得 response，之後才可以在瀏覽器上面呈現我們要的樣子。所以說前端跟後端兩者某種程度來說是融…"
...
sourceFile: "2019-06-28_-------php-----------8bd4bae8968e.html"
---
