...
description: "對岸翻譯，緩存，就是把東西暫存在哪裡讓人讀取。 資料的存取，有分效率跟價格，舉例來說，如果要效率好，快速，就要用記憶體，而如果沒有需要一直存取該筆資料的話，就可以把資料儲存在硬碟，當然硬碟就存取的效率沒這麼好，所以各有好處。"
...
sourceFile: "2019-09-10_-----------Cache---Event-Loop-45c4738cecf4.html"
---
