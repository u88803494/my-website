...
description: "就是一個虛擬的 table。通常用來暫存資料。 在原本的用法上，我們需要建立報表的時候，可能要 JOIN 多個 table。所以就必須要另外寫頁面來執行才可以拿到那些資料。但有的時候，只是需要看這個表格而已，並不需要新增編輯刪除等功能，這時…"
...
sourceFile: "2019-08-25_-----------View-Stored-Procedure---Trigger-8dbcbf5946a9.html"
---
