...
description: "可以稱為 新時代的 XMLHttpRequest，也就是說可以協助我們做 AJAX 的工具。XMLHttpRequest 在現代已經不太被使用，現在大多使用 Fetch，這是比較更簡單得多的操作。"
...
sourceFile: "2019-08-24_----------Fetch---Promise-fe3fa71dfb9a.html"
---
