...
description: "通過前面其他部分的基礎，對 this 就可以深入的理解了。主要 this 的用途就是物件導向，用來指這個物件的 instance，這個功能有其必要性。因為如果沒有 this 也沒有其他的方法來設定這些東西。"
...
sourceFile: "2019-09-26_-----JS---------this-b9b9c6960c03.html"
---
