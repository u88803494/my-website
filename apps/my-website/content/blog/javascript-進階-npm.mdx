...
description: "Node Package Manager, npm. node 套件管理系統 npm（全稱 Node Package Manager，即「node包管理器」）是Node.js預設的、以JavaScript編寫的軟體套件管理系統。"
...
sourceFile: "2019-05-05_JavaScript-----npm-abf96671c915.html"
---
