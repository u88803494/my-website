...
description: "在 JavaScript 裡面，一個很重要的概念就是 Event Loop，是 JavaScript 底層在執行程式碼時的運作方式。請你說明以下程式碼會輸出什麼，以及儘可能詳細地解釋原因。"
...
sourceFile: "2019-09-29_-------event-loop-Scope-hoisting-closure-ffa02ed722fb.html"
---
