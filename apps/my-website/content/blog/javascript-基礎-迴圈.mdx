...
description: "會介紹到一些，不是 JavaScript 內建的迴圈。 迴圈 loop ，也就是一直做一樣的事情，它需要一個終止條件。無窮迴圈，就會不停地一直重複下去，通常是因為沒有給終止條件或是給錯條件。"
...
sourceFile: "2019-04-20_JavaScript-------afffd16841e9.html"
---
