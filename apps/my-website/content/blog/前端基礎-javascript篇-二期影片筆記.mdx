...
description: "這在 JavaScript 是一件非常重要的事情，但其實非常簡單 假設我們要取得一個 function 的回傳值，我們會去設立一個變數去接收，然後會想印出來"
...
sourceFile: "2019-06-06_-----JavaScript---------224f95c80c81.html"
---
...
*Renderer process 有很多的組成，有 main thread(主渲染)、worker threads、compositor thread、raster thread*
...
*頁面的元素按照 html 的標記順序出現，導致產生了錯誤的渲染圖樣，會產生這樣的錯誤，就是因為沒考慮到 z-index*
