...
export const latestArticles: Article[] = [
  {
    "description": "從前端視角理解 SOLID：I — 介面隔離原則，別再硬塞用不到的 Props 了！ 本文為 從前端視角理解 SOLID 系列的第五篇。 第一篇：導論，為何好懂的 React …",
    "publishedDate": "2025-08-01",
    "readTime": "2 min read",
    "subtitle": "從前端視角理解 SOLID：I — 介面隔離原則，別再硬塞用不到的 Props 了！ 本文為 從前端視角理解 SOLID 系列的第五篇。 第一篇：導論，為何好懂的 React …",
    "tags": [
      "AI",
  ...
  {
    "description": "從前端視角理解 SOLID：L — 里氏替換原則，你的「延伸款」別背叛了「基本款」 本文為 從前端視角理解 SOLID …",
    "publishedDate": "2025-08-01",
    "readTime": "2 min read",
