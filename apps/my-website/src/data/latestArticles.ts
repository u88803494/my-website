...
export const latestArticles: Article[] = [
  {
    "description": "到目前為止，我們已經探討了如何拆分職責 (SRP)、如何擴展功能 (OCP)、以及如何確保擴展的可靠性 (LSP)。今天，我們要來解決一個在元件化開發中非常常見的問題：一個元件到底該知道多少事？ 這就是 I — 介面隔離原則 (Interface Segregation Principle, ISP) 要探討的核心。 介面隔離原則 (ISP) 同樣由羅伯特·C·馬丁 (Uncle Bob)…",
    "publishedDate": "2025-08-01",
    "readTime": "2 min read",
    "subtitle": "到目前為止，我們已經探討了如何拆分職責 (SRP)、如何擴展功能 (OCP)、以及如何確保擴展的可靠性 (LSP)。今天，我們要來解決一個在元件化開發中非常常見的問題：一個元件到底該知道多少事？ 這就是 I — 介面隔離原則 (Interface Segregation Principle, ISP) 要探討的核心。 介面隔離原則 (ISP) 同樣由羅伯特·C·馬丁 (Uncle Bob)…",
    "tags": [
      "AI",
  ...
  {
    "description": "但一個新問題浮現了：當我們基於一個「基本款」元件，去擴展出一個「延伸款」時，要如何確保這個延伸款不會失控，甚至破壞掉原有的系統？這就是我們今天要深入探討的，SOLID 中最具哲學思辨的原則：L — 里氏替換原則 (Liskov Substitution Principle, LSP)。 他認為這只是一個樣式上的替換，但現在，他的 submitForm…",
    "publishedDate": "2025-08-01",
    "readTime": "2 min read",
    "subtitle": "但一個新問題浮現了：當我們基於一個「基本款」元件，去擴展出一個「延伸款」時，要如何確保這個延伸款不會失控，甚至破壞掉原有的系統？這就是我們今天要深入探討的，SOLID 中最具哲學思辨的原則：L — 里氏替換原則 (Liskov Substitution Principle, LSP)。 他認為這只是一個樣式上的替換，但現在，他的 submitForm…",
    "tags": [
      "Backend",
      "Front End Development",
      "JavaScript",
