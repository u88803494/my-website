...
const HeroSection: React.FC<HeroSectionProps> = ({ backgroundClass, contactLinkLocale, content, sectionId }) => {
  return (
    <section className={cn("hero relative min-h-screen overflow-hidden", backgroundClass)} id={sectionId}>
      ...
      >
        ...
        <HeroContent contactLinkLocale={contactLinkLocale} content={content} />
      </div>
    </section>
  );
};
