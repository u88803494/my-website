    ...
    <section className={cn("py-20", backgroundClass)} id={sectionId}>
      <div className="container mx-auto max-w-4xl px-4">
        ...
        >
          ...
          <p className="text-base-content/80 mx-auto max-w-2xl text-lg">{t("subtitle")}</p>
        </motion.div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-base-content text-xl font-semibold">{t("email.title")}</h3>
            </div>
            <p className="text-base-content/70 mb-4">{t("email.description")}</p>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h3 className="text-base-content text-xl font-semibold">{t("otherPlatforms.title")}</h3>
            </div>
            <p className="text-base-content/70 mb-6">{t("otherPlatforms.description")}</p>
            <div className="flex justify-center gap-4">
              <ContactLinks variant="circle" />
            </div>
            <div className="mt-6 text-center">
              <div className="text-base-content/60 grid grid-cols-2 gap-2 text-sm">
                <div>{t("otherPlatforms.github")}</div>
                <div>{t("otherPlatforms.linkedin")}</div>
                <div>{t("otherPlatforms.medium")}</div>
                <div>{t("otherPlatforms.email")}</div>
              </div>
            </div>
          </motion.div>
        </div>
