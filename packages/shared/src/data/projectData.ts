...
// Note: This shared projectData uses translation keys
// The actual translations are stored in apps/my-website/messages/*.json
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    descriptionKeys: {
      featureKeys: [
        "tzuchiShop.features.0",
        "tzuchiShop.features.1",
        "tzuchiShop.features.2",
        "tzuchiShop.features.3",
      ],
