...
const Education: React.FC<EducationProps> = ({ backgroundClass, sectionId }) => {
  return (
    <section className={clsx("pt-10 pb-16", backgroundClass)} id={sectionId}>
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          <h2 className="text-4xl font-bold text-base-content mb-4">學歷與進修</h2>
          <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
          <p className="text-lg text-base-content/80">我的學習歷程與背景</p>
        </motion.div>
