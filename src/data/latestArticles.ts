...
export const latestArticles: Article[] = [
  {
    description:
      "在上一篇導論中，我們聊到了 SOLID 原則如何作為一面「透鏡」，幫助我們理解並打造更穩健的前端架構。今天，我們就從這趟旅程的第一站開始，深入探討五大原則中最基礎、也最核心的一個：S — 單一職責原則 (Single Responsibility Principle, SRP)。 如果一個函式同時負責「從 API 獲取資料」、「處理複雜的資料格式轉換」、最後還「根據不同狀態回傳不同的…",
  ...
  {
    description:
      "我從一次面試的提問開始，重新探討 SOLID 與 React Hooks 之間的奇妙連結，這才發現，原來好的程式碼設計，原則都是相通的。",
